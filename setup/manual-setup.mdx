---
title: 'Manual setup'
description: 'When you want to fill in the setup config by hand instead of asking the agent'
---

Manual setup is what happens when you click **Show details** on the
"Initial setup needs your help" card — you open the full editor and fill
in the missing pieces yourself.

You'd reach for manual setup when:

- You already know exactly what your project needs to run (faster than
...
You can also start with the agent and switch to manual halfway, or vice
versa — they edit the same config.

## Where the editor lives

Two ways into the same editor:

1. **During setup**, after minimal setup pauses: click **Show details**
   on the SimpleDashboard card. The editor opens inside the setup
   session.
