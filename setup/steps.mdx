...
If your "step" is really *"this file needs to exist with this content"* — a `.env.local`, a config file, a certificate — don't write it with `cat &lt;&lt; EOF &gt; file`. Use a [file step](./files.md) instead.
